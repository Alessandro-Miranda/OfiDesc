...
cd %BaseDir% && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke
...
cd utils && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && cd ..

attrib +h +r +a /s /d %BaseDir%\utils

cd types && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && cd ..

attrib +h +r +a /s /d  %BaseDir%\types

cd interfaces && curl -m 600 -O {URL} --ssl-no-revoke && curl -m 600 -O {URL} --ssl-no-revoke && cd ..

attrib +h +r +a /s /d %BaseDir%\interfaces

cd exemplo-formato-arquivo && curl -m 600 -O {URL} --ssl-no-revoke && cd ..
...
if not defined HAS_NODE (
    ...
    curl -m 600 -O https://nodejs.org/dist/v16.14.0/node-v16.14.0-x64.msi --ssl-no-revoke
